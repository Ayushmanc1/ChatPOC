...
function PopOut_Down(scroller) {
    ...
    if (panel && ((panel.offset + panel.clippedHeight) < panel.PlaceHolder1ysicalHeight)) {
...
function PopOut_Position(panel, hideScrollers) {
    ...
    var panelHeight = ((typeof(panel.PlaceHolder1ysicalHeight) != "undefined") && (panel.PlaceHolder1ysicalHeight != null)) ?
        panel.PlaceHolder1ysicalHeight :
        panelCoordinates.height;
    panel.PlaceHolder1ysicalHeight = panelHeight;
...
function PopOut_SetPanelHeight(element, height, doNotClip) {
    if (element && element.style) {
        ...
        element.PlaceHolder1ysicalWidth = size.width;
...
function PopOut_ShowScrollers(panel) {
    if (panel && panel.style) {
        ...
        if (up && dn) {
            ...
            if (panel.offset + panel.clippedHeight + 2 <= panel.PlaceHolder1ysicalHeight) {
