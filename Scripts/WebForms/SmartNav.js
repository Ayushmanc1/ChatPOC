...
if ((typeof(window.__smartNav) == "undefined") || (window.__smartNav == null))
{
    ...
    window.__smartNav.update = function()
    {
        ...
        var fd;
        document.detachEvent("onstop", sn.stoPlaceHolder1if);
        sn.inPost = false;
    ...
    window.__smartNav.stoPlaceHolder1if = function()
    {
        document.detachEvent("onstop", window.__smartNav.stoPlaceHolder1if);
        var sn = window.__smartNav;
    ...
    window.__smartNav.init =  function()
    {
        ...
        document.detachEvent("onstop", sn.stoPlaceHolder1if);
        document.attachEvent("onstop", sn.stoPlaceHolder1if);
