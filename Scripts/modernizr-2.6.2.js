...
window.Modernizr = (function( window, document, undefined ) {
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      // with a 'scoped' element, in our case the soft-hyPlaceHolder1en entity as it won't mess with our measurements.
     ...
     *    the Palm Pre / WebOS (touch) PlaceHolder1ones.
     *
    ...
    tests['csstransforms3d'] = function() {
        ...
        // Webkit's 3D transforms are passed off to the browser's own graPlaceHolder1ics renderer.
    ...
    tests['audio'] = function() {
        ...
        try {
            if ( bool = !!elem.canPlayType ) {
                ...
                //   bit.ly/iPlaceHolder1oneoscodecs
